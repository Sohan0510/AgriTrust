...
import merkleRoutes from './src/routes/merkle.js';
import witnessRoutes from './src/routes/witnesses.js';
...
// Verification routes
app.use('/api/verification', authRequired, verificationRoutes);

// Merkle Tree routes
app.use('/api/merkle', authRequired, merkleRoutes);

// Witness routes
app.use('/api/witnesses', authRequired, witnessRoutes);

// Readings routes
app.use('/api/readings', authRequired, readingsRoutes);
